                                ...
                                <div class="card-body">
                                    ...
                                    @method('PUT')
                                        ...
                                        <div class="position-relative row form-group mb-1">
                                            ...
                                            <a href="{{ route('admin.category.index') }}" class="border-0 btn btn-outline-danger mr-1 btn-hover-shine">
                                                ...
                                                <button type="submit" class="btn-shadow btn-hover-shine btn btn-info">
