        ...
        <div class="row">
            <div class="col-md-12">
                <div class="main-card mb-3 card">
                    <form action="{{route('users.update', ['user'=>$user->id])}}" class="pt-5 pb-3 px-5" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row">
							...
							<div class="col-md-9 d-grid gap-4">
                                <input type="text" value="{{$user->name}}" id="inputName" name="name">
								<input type="text" value="{{$user->phone}}" id="inputPhone" name="phone">
								<input type="text" value="{{$user->address}}" id="inputAddress" name="address">
								<input type="file" id="inputAvatar" name="avatar">
							</div>
						</div>
                        <div class="row mt-4 justify-content-center">
                            <button type="submit" class="btn btn-danger col-md-2">Sửa</button>
                        </div>
                    </form>
                </div>
            </div>
